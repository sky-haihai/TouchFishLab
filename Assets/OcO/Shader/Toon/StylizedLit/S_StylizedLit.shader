...
[Toggle(_ENABLESHADOW_ON)]             _ReceiveShadows ("Receive Shadows (if on) / Else off", Int) = 1
    ...
    HLSLPROGRAM
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                half3 color = 0;
                color += MyStylizedGI(brdfData, rampDiffuse, inputData.bakedGI, surfaceData.occlusion, inputData.normalWS, inputData.viewDirectionWS, _Metallic, lerp(1, ndotl, _DirectionalFresnel));
